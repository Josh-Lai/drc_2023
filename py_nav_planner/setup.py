...
setup(
    ...
    description='A modified importable library for writing mobile robot applications in python3',
    license='Apache-2.0',
    ...
    entry_points={
        'console_scripts': [
                ...
                'py_nav_planner = nav2_simple_commander.py_nav_planner:main'
