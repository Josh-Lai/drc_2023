...
class LaneDetection():
    ...
    def get_error(self):
        ...
        cv2.drawContours(frame1, yellowContours, -1, (0, 255, 0), 2) 
...
def main():
    rclpy.init()
    #cap = cv2.VideoCapture("../resource/video1.mov") #0 means its continuous
    cap = cv2.VideoCapture(1) #0 means its continuous
