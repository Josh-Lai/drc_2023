...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.enable_auto_white_balance', 'default': 'false', 'description': 'enable/disable auto exposure for color image'},
                           {'name': 'rgb_camera.white_balance',     'default': '2800.0', 'description': 'enable/disable auto exposure for color image'},
                           ...
                           {'name': 'depth_module.global_time_enabled',     'default': 'false', 'description': 'Initial value for hdr_merge filter'},
                           {'name': 'rgb_camera.global_time_enabled',     'default': 'true', 'description': 'Initial value for hdr_merge filter'},
