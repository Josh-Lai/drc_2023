...
{
  int16_t accel_x = i2c_smbus_read_word_data(file_, ACCEL_XOUT_H + 1);
...
{
  int16_t accel_y = i2c_smbus_read_word_data(file_, ACCEL_YOUT_H + 1);
...
{
  int16_t accel_z = i2c_smbus_read_word_data(file_, ACCEL_ZOUT_H + 1);
...
{
  int16_t gyro_x = i2c_smbus_read_word_data(file_, GYRO_XOUT_H + 1);
...
{
  int16_t gyro_y= i2c_smbus_read_word_data(file_, GYRO_YOUT_H + 1);
...
{
  int16_t gyro_z= i2c_smbus_read_word_data(file_, GYRO_ZOUT_H + 1);
